...
class DetailView(APIView):
    """
    Он предназначен для предоставления информации о пользователе.
    """
...
class AttendanceView(APIView):
    """
    для проверки посещаемости пользователя.
    """
    permission_classes = [IsAuthenticated, ]
...
class MarksView(APIView):
    """
    проверки оценок пользователя по различным предметам, выставленных преподавателем.
    """
    permission_classes = [IsAuthenticated, ]
...
class TimetableView(APIView):
    """
    расписание соответствующего класса, к которому приписан пользователь.
    """
