...
'''Этот код представляет собой список URL-шаблонов для маршрутизации запросов веб-приложения. Каждый URL-шаблон определяет путь к определенной функции представления (view function) в приложении.
None устанавливает значение site_url в None, что означает, что ссылка на главную страницу административной панели не будет отображаться.
устанавливает значение site_header в 'My Site', что изменяет текст заголовка административной панели на "My Site".'''